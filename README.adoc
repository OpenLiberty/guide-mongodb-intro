...
:page-description: Learn how to persist data to a document-oriented MongoDB database for your microservices.
...
:page-seo-title: Persisting data with a document-oriented MongoDB database
:page-seo-description: A getting started tutorial with examples on how to access and persist data to a document-oriented MongoDB database with Open Liberty by using Contexts and Dependency Injection (CDI), and configure MongoDB through MicroProfile Config.
...
Learn how to persist data to a document-oriented MongoDB database for your microservices.
