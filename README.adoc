...
:page-description: Learn how to access and persist data with MongoDB using Contexts and Dependency Injection (CDI) and MicroProfile Config.
...
:page-seo-title: Building a microservice with MongoDB
:page-seo-description: A getting started tutorial with examples on how to access and persist data with MongoDB using Contexts and Dependency Injection (CDI) and MicroProfile Config.
...
Learn how to access and persist data with `MongoDB` using Contexts and Dependency Injection (CDI) and MicroProfile Config.
