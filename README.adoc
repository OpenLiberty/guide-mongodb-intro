...
Test the `READ` operation from the OpenAPI UI at the `GET /api/crew` end  point.
...
If you see `The application guide-mongodb-intro updated in 1.023 seconds.` in the console, then it is ready for you to check out the microservice that you created at the http://localhost:9080/mongo/[^] URL. 
