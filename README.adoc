...
For more information about these packages, see the https://mongodb.github.io/mongo-java-driver/3.12/javadoc/com/mongodb/client/package-summary.html[com.mongodb.client^]
...
For more information about creating a RESTful service with JAX-RS, JSON-B, and Open Liberty, see the guide on https://openliberty.io/guides/rest-intro.html[Creating a RESTful web serivce^].
...
This method updates all of the matching queries with the new document. Because the object `id` is unique in the `Crew` collection,
...
The features that are required to create the CDI producer for MongoDB are https://openliberty.io/docs/latest/reference/feature/cdi-2.0.html[Contexts and Dependency Injection] (`cdi-2.0`),
https://openliberty.io/docs/latest/reference/feature/ssl-1.0.html[Secure Socket Layer] (`ssl-1.0`), https://openliberty.io/docs/latest/reference/feature/mpConfig-2.0.html[MicroProfile Config] (`mpConfig-2.0`),
