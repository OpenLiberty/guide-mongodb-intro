...
The `mongodb.conf` file specifies the configuration to use when starting a `mongo` instance. A sample configuration file is provided which sets up [hotspot=net]`net` to use TLS. Additional configuration options can be found in the official https://docs.mongodb.com/manual/reference/configuration-options/[MongoDB website].
