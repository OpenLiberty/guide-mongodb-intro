...
If you see `The defaultServer server is ready to run a smarter planet. The defaultServer server started in 4.300 seconds.` in the console, then it is ready for you to check out the microservice that you created at the http://localhost:9080/mongo/[^] URL. 
