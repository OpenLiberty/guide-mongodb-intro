...
Using [hotspot file=2]`MicroProfile Config` makes configuring the `MongoDB` driver simple because all of the configuration can be set in one place and injected into the CDI producer.
