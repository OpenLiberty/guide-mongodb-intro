...
//----------------------------------------------------------
// Delete the above instructions as you start writing your guide

## APPENDIX A: A template README.adoc
Please open the README.adoc in a text editor or view it in `raw` form. 
Follow the directions in the comments to remove all the instructions before `APPENDIX A` prior to commit. 
Most comments should be removed, although not the copyright.


```
// As you start writing your guide, keep everything between BEGIN and END in the README.adoc, meaning delete anything else that is above or below the statements 
// ----------- BEGIN -----------
