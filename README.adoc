...
This generates an AES encoding of the password `openliberty`. Copy the output and replace [hotspot=mongoPassword file=0]`openliberty` with the [hotspot=mongoPassword file=1]`encoded password`.
